...
const Color appBarColor = Color(0xFF00880F);
const Color title_color = Color.fromARGB(255, 253, 170, 93);
const Color text_color = Color.fromARGB(255, 41, 48, 65);
const Color bgicon = Color.fromARGB(255, 74, 183, 181);
const Color bg_search = Color.fromARGB(255, 239, 241, 243);
const Color bg_lonceng = Color.fromARGB(255, 232, 239, 243);
const Color lonceng = Color.fromARGB(255, 234, 113, 115);
const Color bg = Color.fromRGBO(19, 20, 13, 1);
const Color nv = Color.fromARGB(255, 197, 197, 197);
const Color onclick_nv = Color.fromARGB(255, 191, 222, 97);
const Color greentitle = Color.fromARGB(255, 48, 55, 51);

const Color bg_popular1 = Color.fromARGB(255, 74, 183, 181);
const Color bg_popular2 = Color.fromARGB(255, 75, 156, 203);
...
const db2_light_blue = Color(0xFFADD8E6);
